...
import { DEFAULT_SUB_DEPARTMENT_STATUSES } from "@/lib/board-columns"
...
export async function POST(request: Request) {
  ...
  try {
    ...
    // given its own. Best-effort — never fails sub-department creation.
    await prisma.subDepartmentStatus
      .createMany({
