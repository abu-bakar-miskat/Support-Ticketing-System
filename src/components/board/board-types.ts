...
export const UI_PRIORITY_STYLE: Record<UiPriority, PriorityStyle> = {
  ...
  critical: {
    dot: "bg-[#dc2626]",
    pillBg: "bg-sts-red-tint dark:bg-[#3a2220]",
...
export const UI_STATUS_STYLE: Record<CanonicalStatus, StatusStyle> = {
  ...
  "In Progress": {
    dot: "bg-sts-blue",
    pillBg: "bg-sts-blue-tint dark:bg-[#1a3444]",
    pillText: "text-[#0369a1] dark:text-[#7dd3fc]",
    filterBg: "bg-sts-blue-tint dark:bg-[#1a3444]",
    filterText: "text-[#0369a1] dark:text-[#7dd3fc]",
    filterCount: "text-[#0369a1]/70 dark:text-[#7dd3fc]/70",
    filterActiveBg: "bg-sts-blue-tint dark:bg-[#1f3d50]",
    filterActiveBorder: "border-sts-blue/40 dark:border-[#7dd3fc]/40",
    filterActiveText: "text-[#0369a1] dark:text-[#7dd3fc]",
  },
  "Pull Request": {
    dot: "bg-sts-purple",
    pillBg: "bg-sts-purple-tint dark:bg-[#2a2440]",
    pillText: "text-[#6d28d9] dark:text-[#c4b5fd]",
    filterBg: "bg-sts-purple-tint dark:bg-[#2a2440]",
    filterText: "text-[#6d28d9] dark:text-[#c4b5fd]",
    filterCount: "text-[#6d28d9]/70 dark:text-[#c4b5fd]/70",
    filterActiveBg: "bg-sts-purple-tint dark:bg-[#322a4a]",
    filterActiveBorder: "border-sts-purple/40 dark:border-[#c4b5fd]/40",
    filterActiveText: "text-[#6d28d9] dark:text-[#c4b5fd]",
  },
  Live: {
    dot: "bg-sts-green",
    pillBg: "bg-sts-green-tint dark:bg-[#152a20]",
    pillText: "text-[#15803d] dark:text-[#6ee7a0]",
    filterBg: "bg-sts-green-tint dark:bg-[#152a20]",
    filterText: "text-[#15803d] dark:text-[#6ee7a0]",
    filterCount: "text-[#15803d]/70 dark:text-[#6ee7a0]/70",
    filterActiveBg: "bg-sts-green-tint dark:bg-[#1a3328]",
    filterActiveBorder: "border-sts-green/40 dark:border-[#6ee7a0]/40",
  ...
  Blocked: {
    ...
    pillBg: "bg-sts-red-tint dark:bg-[#3a2220]",
    pillText: "text-[#b91c1c] dark:text-[#fca5a5]",
    filterBg: "bg-sts-red-tint dark:bg-[#3a2220]",
    filterText: "text-[#b91c1c] dark:text-[#fca5a5]",
    filterCount: "text-[#b91c1c]/70 dark:text-[#fca5a5]/70",
    filterActiveBg: "bg-sts-red-tint dark:bg-[#442828]",
    filterActiveBorder: "border-sts-red/40 dark:border-[#fca5a5]/40",
...
const LABEL_STYLES: LabelStyle[] = [
  {
    dot: "#0a76b9",
    bg: "bg-sts-blue-tint dark:bg-[#1a3444]",
    text: "text-[#0369a1] dark:text-[#7dd3fc]",
  },
  {
    dot: "#16a34a",
    bg: "bg-sts-green-tint dark:bg-[#152a20]",
  ...
  {
    dot: "#dc2626",
    bg: "bg-sts-red-tint dark:bg-[#3a2220]",
    text: "text-[#b91c1c] dark:text-[#fca5a5]",
  },
  {
    dot: "#7c3aed",
    bg: "bg-sts-purple-tint dark:bg-[#2a2440]",
