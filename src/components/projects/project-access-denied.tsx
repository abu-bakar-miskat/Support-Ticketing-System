    ...
    <div className="flex h-full min-h-[60vh] flex-col items-center justify-center px-6 py-16">
      <div className="flex max-w-[440px] flex-col items-center gap-5 text-center">
        ...
        <div className="flex flex-col gap-1.5">
          <h1 className="sts-text-page-title">You don&apos;t have access to this project</h1>
          <p className="font-sans text-[13px] leading-relaxed text-sts-muted">{body}</p>
        </div>
        ...
        <div className="mt-1 flex items-center gap-1.5 rounded-lg border border-sts-card-border bg-sts-surface px-3 py-1.5">
          ...
          <span className="font-sans text-[11.5px] text-sts-subtle">
            {projectName ? (
              <>
                Project <span className="font-semibold text-sts-foreground">{projectName}</span> — access denied
              </>
            ) : (
              "Access denied"
            )}
