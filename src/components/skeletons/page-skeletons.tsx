...
function StatCardSkeleton() {
  return (
    <div className="flex flex-col gap-1.5 rounded-xl border border-sts-card-border bg-sts-card px-[18px] py-4">
...
function BoardCardSkeleton({ opacity }: { opacity: number }) {
  return (
    <div
      className="flex flex-col gap-2 rounded-lg border border-sts-card-border bg-sts-card p-3"
      style={{ opacity }}
    >
...
function OverviewTabSkeleton() {
  return (
    <div className="flex flex-col gap-3 p-2 sm:p-3">
      <div className="grid grid-cols-3 gap-px overflow-hidden rounded-xl border border-sts-card-border bg-sts-card-border sm:grid-cols-6">
        {Array.from({ length: 6 }).map((_, i) => (
          <div
            key={i}
            className="flex items-center justify-between gap-2 bg-sts-card px-3 py-2.5 sm:flex-col sm:items-start sm:gap-0.5 sm:py-2"
          >
      ...
      <div className="grid grid-cols-1 gap-3 min-[760px]:grid-cols-2 min-[760px]:items-start">
        <div className="flex min-w-0 flex-col gap-3">
          ...
          <div className="rounded-xl border border-sts-card-border bg-sts-card px-4 py-3">
            ...
            {[0, 1].map((i) => (
              <div
                key={i}
                className={cn(
                  "rounded-xl border border-sts-card-border/60 bg-sts-surface/30 p-3",
                  i > 0 && "mt-3",
                )}
              >
          ...
          <div className="rounded-xl border border-sts-card-border bg-sts-card px-4 py-3">
            ...
            <div className="flex items-center gap-3 rounded-lg border border-dashed border-sts-card-border px-3 py-3">
        ...
        <div className="flex min-w-0 flex-col gap-3">
          {["Time logged", "Ticket contributions"].map((label) => (
            <div
              key={label}
              className="rounded-xl border border-sts-card-border bg-sts-card px-4 py-3"
            >
              <div className="mb-2.5 flex items-center justify-between gap-2">
          ...
          <div className="flex max-h-[420px] flex-col overflow-hidden rounded-xl border border-sts-card-border bg-sts-card">
            ...
            {Array.from({ length: 5 }).map((_, i) => (
              <div
                key={i}
                className="flex items-center gap-2.5 border-t border-sts-card-border/60 px-3 py-2"
                style={fade(i, 0.08)}
              >
    ...
    <>
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div
            key={i}
            className="flex flex-col gap-2 rounded-xl border border-sts-card-border bg-sts-card px-4 py-3.5"
          >
...
export function MentionCardSkeleton({ style }: { style?: CSSProperties }) {
  return (
    <article
      className="flex flex-col gap-2 rounded-[10px] border border-sts-card-border bg-sts-card px-[18px] py-3.5"
      style={style}
    >
      ...
      <div className="rounded-lg bg-sts-bg px-3 py-2.5">
        <Skeleton className="h-3 w-full" />
    ...
    <>
      <div className="flex flex-col gap-4 lg:flex-row">
        <div className="flex w-full shrink-0 flex-col gap-1.5 rounded-xl border border-sts-card-border bg-sts-card px-[18px] py-4 lg:w-[300px]">
          ...
          <Skeleton className="h-2 w-full rounded bg-sts-surface" />
    ...
    <div className="flex flex-col gap-6 pt-5">
      <div className="flex flex-wrap gap-2">
        {[0, 1, 2].map((i) => (
          <div
            key={i}
            className="flex items-center gap-2 rounded-lg bg-sts-surface px-3 py-2"
          >
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          {[0, 1].map((i) => (
            <div
              key={i}
              className="flex flex-col gap-3 rounded-xl border border-sts-card-border bg-sts-card px-4 py-4"
            >
      ...
      <div className="flex flex-col gap-2">
        <Skeleton className="h-3 w-28" />
        <div className="flex flex-col divide-y divide-[#f0f4f8] overflow-hidden rounded-xl border border-sts-card-border bg-sts-card dark:divide-[#3a3a37]">
          {[0, 1, 2].map((i) => (
  ...
  return (
    <>
      {Array.from({ length: count }).map((_, i) => (
        <div
          key={i}
          className="flex items-center gap-4 border-b border-sts-card-border/60 px-4 py-3 last:border-b-0"
          style={fade(i)}
        >
          <Skeleton className="h-4 w-36" />
          <Skeleton className="h-5 w-20 rounded-full" />
...
export function SubDepartmentTimeStatsRowSkeleton({ count = 4 }: { count?: number }) {
  return (
    <div className="contents">
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="flex flex-col gap-1 rounded-xl border border-sts-card-border bg-sts-card px-4 py-3.5">
          <Skeleton className="h-2.5 w-20" />
...
export function SubDepartmentTimeTableRowsSkeleton({ count = 4 }: { count?: number }) {
  return (
    <>
      <div className="flex min-w-[900px] items-center gap-4 border-b border-sts-card-border px-[18px] py-2.5">
      ...
      {Array.from({ length: count }).map((_, i) => (
        <div
          key={i}
          className="flex min-w-[900px] items-center gap-4 border-b border-sts-card-border/60 px-[18px] py-3 last:border-b-0"
          style={fade(i)}
        >
...
export function ProjectDetailHeaderSkeleton() {
  return (
    <div className="sts-page-header shrink-0 border-b border-sts-card-border bg-sts-card">
      ...
      <div className="sts-header-scroll">
          ...
          {[
            ...
            <div
              ...
              className={cn(
                ...
                active ? "border-sts-id" : "border-transparent",
              )}
            >
...
export function HomeDashboardSkeleton() {
  return (
    <div className="sts-page-pad h-full overflow-y-auto">
      <div className="mb-5 flex items-start justify-between gap-4">
        <div className="min-w-0 space-y-1">
          <p className="font-sans text-[18px] font-medium text-sts-muted sm:text-[20px]">
            Good day,
          </p>
    ...
    <>
      <div className="shrink-0 px-4 py-2 sm:px-6 xl:px-8">
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-1">
          ...
          <Skeleton className="hidden h-5 w-px shrink-0 bg-sts-card-border sm:block" />
        ...
        <table className="w-full min-w-[640px] border-collapse">
          ...
          <tbody>
            {Array.from({ length: 10 }).map((_, i) => (
              <tr
                key={i}
                className="border-b border-sts-card-border/60"
                style={fade(i, 0.05)}
              >
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden">
      <div className="flex shrink-0 items-center gap-1 border-b border-sts-card-border bg-sts-card px-4 py-1.5 sm:px-6 xl:px-8">
        <span className="flex h-8 items-center gap-1.5 rounded-md bg-sts-blue px-3 font-sans text-[12.5px] font-medium text-white dark:text-gray-900">
          My Tasks
        </span>
        <span className="flex h-8 items-center gap-1.5 rounded-md px-3 font-sans text-[12.5px] font-medium text-sts-muted">
          All Tasks
        </span>
        <span className="flex-1" />
        <span className="flex h-8 items-center gap-1.5 rounded-md bg-sts-blue px-3 font-sans text-[12.5px] font-medium text-white opacity-50 dark:text-gray-900">
          New Task
        </span>
      </div>
      <TasksTableSkeleton />
    ...
    <div className="flex h-full flex-col overflow-hidden">
      <div className="shrink-0 px-4 pt-2 pb-2 sm:px-6 xl:px-8">
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <span className="hidden h-4 w-px shrink-0 bg-sts-card-border md:block" />
...
export function ProjectsPageSkeleton() {
  return (
    <div className="flex h-full flex-col overflow-hidden">
      <div className="flex items-center gap-1 border-b border-sts-card-border bg-sts-card px-4 py-1.5 sm:px-6 xl:px-8">
        <span className="flex h-8 items-center gap-1.5 rounded-md bg-sts-blue px-3 font-sans text-[12.5px] font-medium text-white dark:text-gray-900">
          My Projects
        </span>
        <span className="flex h-8 items-center gap-1.5 rounded-md px-3 font-sans text-[12.5px] font-medium text-sts-muted">
      ...
      <div className="flex items-center gap-2 border-b border-sts-card-border px-5 py-3">
    ...
    <div className="flex-1 overflow-y-auto p-5">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {Array.from({ length: 9 }).map((_, i) => (
          <div
            key={i}
            className="flex flex-col gap-3 rounded-xl border border-sts-card-border p-4"
            style={fade(i, 0.07)}
          >
            <div className="flex items-center gap-2">
    ...
    <div className="flex h-full flex-col overflow-hidden">
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        {Array.from({ length: 8 }).map((_, i) => (
          <div key={i} className="flex items-center gap-4 border-b border-sts-card-border py-3" style={fade(i, 0.05)}>
            <Skeleton className="size-8 shrink-0 rounded-full" />
...
export function TicketDetailSkeleton({
  ...
  return (
    <div className="flex h-full min-h-0 w-full overflow-hidden bg-sts-bg">
      <div className="min-h-0 min-w-0 flex-1 overflow-y-auto pb-4 pt-[22px]">
        <div className="w-full space-y-3.5 px-8">
          ...
          {/* Description */}
          <div className="flex flex-col gap-2 rounded-lg border border-sts-card-border p-4">
            {Array.from({ length: 4 }).map((_, i) => (
      ...
      <aside className="hidden w-[300px] shrink-0 flex-col overflow-hidden border-l border-sts-card-border bg-sts-card lg:flex">
        {showDrawerChrome && (
...
export function InboxPageSkeleton() {
  return (
    <div className="h-full overflow-y-auto px-5 py-5 sm:px-8 lg:px-12">
      ...
      />
      <div className="mb-4 flex w-fit gap-0.5 rounded-lg border border-sts-card-border bg-sts-card p-0.5">
        {["All", "Unread", "Mentions", "Assigned"].map((label) => (
          <span
            key={label}
            className="flex h-7 items-center rounded-md px-2.5 font-sans text-[12px] text-sts-muted"
          >
            {label}
          </span>
        ))}
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      {Array.from({ length: 6 }).map((_, i) => (
        <div
          key={i}
          className="mb-1 flex items-start gap-3 rounded-lg border border-sts-card-border px-4 py-[9px]"
          style={fade(i, 0.08)}
        >
...
export function ManagerDashboardSkeleton() {
  return (
    <div className="flex h-full flex-col overflow-hidden">
      <div className="sts-page-header shrink-0">
        <div className="flex items-start justify-between gap-4 pb-4">
          <div className="flex min-w-0 flex-1 flex-col gap-3">
            ...
            <div className="flex overflow-hidden rounded-xl border border-sts-card-border bg-sts-card">
              {[56, 48, 60].map((w, i) => (
                <div key={i} className="flex items-center gap-2 border-r border-sts-card-border px-4 py-2 last:border-r-0">
                  <Skeleton className="h-5 w-6" />
      ...
      <div className="flex min-h-0 flex-1 gap-4 overflow-hidden px-4 pb-4 sm:px-6 sm:pb-6 xl:px-8">
        <div className="flex flex-[3] flex-col overflow-hidden rounded-xl border border-sts-card-border bg-sts-card">
          ...
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="flex items-center gap-3 border-b border-sts-card-border/50 px-4 py-3 last:border-b-0" style={fade(i)}>
              <Skeleton className="size-7 rounded-full" />
        ...
        <div className="flex flex-[2] min-h-0 flex-col gap-4">
          {[0, 1].map((panel) => (
            <div key={panel} className="flex flex-1 flex-col overflow-hidden rounded-xl border border-sts-card-border bg-sts-card">
              <div className="flex items-center gap-2 border-b border-sts-card-border px-4 py-2.5">
                <Skeleton className="size-[7px] rounded-full" />
                <Skeleton className="h-3 w-24" />
                <Skeleton className="ml-auto h-3 w-4" />
              ...
              {Array.from({ length: 3 }).map((_, i) => (
                <div key={i} className="flex items-center gap-3 border-b border-sts-card-border/50 px-4 py-3 last:border-b-0">
                  <Skeleton className="size-7 rounded-full" />
                  <Skeleton className="h-3.5 flex-1" />
                </div>
              ))}
    ...
    <div className="h-full overflow-y-auto">
      <div className="border-b border-sts-card-border bg-sts-card/50 px-6 py-6 sm:px-10">
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="flex flex-col gap-2 rounded-2xl border border-sts-card-border p-5">
  ...
  return (
    <div className="sts-page-pad flex h-full flex-col gap-4 overflow-y-auto">
      <PageHeader
        ...
        actions={
          <>
            <span className="flex h-[30px] w-[160px] shrink-0 items-center justify-between gap-2 rounded-md border border-sts-card-border bg-sts-card px-3 font-sans text-[11.5px] font-semibold text-sts-foreground">
              All projects
            </span>
            <span className="flex h-[30px] w-[180px] shrink-0 items-center justify-between gap-2 rounded-md border border-sts-card-border bg-sts-card px-3 font-sans text-[11.5px] font-semibold text-sts-foreground">
              Last 30 days
            </span>
          </>
        }
    ...
    <>
      ...
      <div className="grid auto-rows-fr grid-cols-1 gap-3.5 md:grid-cols-3">
        {["STATUS", "PRIORITY", "OPEN VS CLOSED"].map((title) => (
          <div key={title} className="rounded-xl border border-sts-card-border bg-sts-card p-4">
            <p className="mb-4 font-sans text-[11.5px] font-semibold tracking-[1px] text-sts-subtle">
              {title}
            </p>
      ...
      <div className="grid auto-rows-fr grid-cols-1 gap-3.5 md:grid-cols-3">
        {["CREATED", "RESOLVED", "TOP CONTRIBUTORS"].map((title) => (
          <div key={title} className="rounded-xl border border-sts-card-border bg-sts-card p-4">
            <p className="mb-3 font-sans text-[11.5px] font-semibold tracking-[1px] text-sts-subtle">
              {title}
            </p>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <div className="flex h-8 overflow-hidden rounded-lg border border-sts-card-border bg-sts-surface">
              {["All time", "Today", "7 days", "30 days", "90 days"].map((label, i) => (
                <span
                  ...
                  className={
                    i === 0
                      ? "bg-sts-card px-3 font-sans text-[12px] font-semibold text-sts-foreground shadow-sm"
                      : "px-3 font-sans text-[12px] text-sts-muted"
                  }
                >
                  {label}
                </span>
            ...
            <div className="flex h-8 items-center gap-1 rounded-lg border border-sts-card-border bg-sts-surface px-1.5">
              {["Urgent", "Critical", "High", "Medium", "Low"].map((p) => (
                <span key={p} className="px-2 py-1 font-sans text-[12px] text-sts-muted">
                  {p}
                </span>
              ))}
            </div>
            <span className="flex h-8 items-center gap-1.5 rounded-lg border border-sts-card-border bg-sts-surface px-3 font-sans text-[12px] font-medium text-sts-muted">
              Urgent only
            </span>
          </div>
          }
    ...
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap gap-3">
        {["Total tickets", "Urgent", "Critical", "Blocked", "Resolved in range"].map((label, i) => (
          <div
            key={label}
            className="flex min-w-[130px] flex-col gap-1.5 rounded-xl border border-sts-card-border bg-sts-card px-4 py-3"
            style={fade(i, 0.08)}
          >
            <Skeleton className="h-6 w-10" />
            <p className="font-sans text-[11.5px] text-sts-muted">{label}</p>
          </div>
        ))}
      </div>
      ...
      {Array.from({ length: 3 }).map((_, i) => (
        <div
          key={i}
          className="rounded-xl border border-sts-card-border bg-sts-card p-4"
          style={fade(i, 0.08)}
        >
...
export function SprintsPageSkeleton() {
  return (
    <div className="flex h-full flex-col overflow-hidden">
      <div className="sts-page-pad flex h-full flex-col gap-0 overflow-hidden">
        <PageHeader
          title="Sprints"
          icon={Zap}
          iconClassName="text-sts-blue"
        ...
        />
        <div className="mt-4 flex gap-4 border-b border-sts-card-border sm:mt-5">
          <Skeleton className="mb-2 h-4 w-20" />
          <Skeleton className="mb-2 h-4 w-24" />
        </div>
        <div className="mt-5 grid grid-cols-1 gap-4 lg:grid-cols-2">
          {Array.from({ length: 2 }).map((_, i) => (
            <div key={i} className="rounded-xl border border-sts-card-border bg-sts-card p-4">
        ...
        <div className="mt-5 flex-1 overflow-hidden rounded-xl border border-sts-card-border bg-sts-card">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="flex items-center gap-4 border-b border-sts-card-border/60 px-4 py-3 last:border-b-0" style={fade(i)}>
              <Skeleton className="h-4 w-36" />
              <Skeleton className="h-5 w-20 rounded-full" />
              <Skeleton className="h-3 w-28" />
              <Skeleton className="ml-auto h-3 w-12" />
  ...
  return (
    <div className="flex flex-col gap-6 px-6 py-8 sm:px-10">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {Array.from({ length: 9 }).map((_, i) => (
          <div key={i} className="flex items-center gap-3 rounded-xl border border-sts-card-border p-4" style={fade(i, 0.06)}>
...
export function IntakeFormsPageSkeleton() {
  return (
    <div className="flex flex-col gap-6 px-5 py-8 sm:px-8 lg:px-10">
      ...
      <div className="overflow-hidden rounded-xl border border-sts-card-border bg-sts-card">
        <div className="flex items-center gap-4 border-b border-sts-card-border px-4 py-3">
        ...
        {Array.from({ length: 5 }).map((_, i) => (
          <div
            key={i}
            className="flex items-center gap-4 border-b border-sts-card-border/60 px-4 py-3.5 last:border-b-0"
            style={fade(i, 0.07)}
          >
            <Skeleton className="h-4 w-36" />
...
export function IntakeFieldBuilderSkeleton() {
  return (
    <div className="flex flex-col gap-6 px-5 py-8 sm:px-8 lg:px-10">
      ...
      <div className="rounded-xl border border-sts-card-border bg-sts-card p-4">
        <Skeleton className="mb-4 h-4 w-24" />
        {Array.from({ length: 4 }).map((_, i) => (
          <div
            key={i}
            className="mb-2 flex items-center gap-3 rounded-lg border border-sts-card-border px-3 py-3 last:mb-0"
            style={fade(i, 0.08)}
          >
...
export function IntakeSubmissionDetailSkeleton() {
  return (
    <div className="flex flex-col gap-6 px-5 py-8 sm:px-8 lg:px-10">
      ...
      <div className="rounded-xl border border-sts-card-border bg-sts-card p-5">
        {Array.from({ length: 6 }).map((_, i) => (
...
export function ActivityPageSkeleton() {
  return (
    <div className="h-full overflow-y-auto px-5 py-6 sm:px-8 lg:px-12">
      ...
      <div className="mb-4 rounded-xl border border-sts-card-border bg-sts-card px-4 py-3">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex gap-0.5 rounded-lg border border-sts-card-border bg-sts-surface p-0.5">
            {["Today", "Yesterday", "Last 7 days", "Last 30 days", "Custom"].map((label) => (
              <span
                key={label}
                className="rounded-md px-3 py-1 font-sans text-[11.5px] font-medium text-sts-muted"
              >
                {label}
              </span>
            ))}
...
export function ActivityFeedSkeleton() {
  return (
    <>
      <div className="mb-5 grid grid-cols-3 gap-px overflow-hidden rounded-xl border border-sts-card-border bg-sts-card-border sm:grid-cols-6">
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="flex flex-col gap-2 bg-sts-card px-4 py-3">
            <Skeleton className="h-2.5 w-16" />
            <Skeleton className="h-6 w-10" />
          </div>
        ))}
        ...
        {(["Today", "Yesterday"] as const).map((label, gi) => (
          <div key={label} className="flex flex-col">
            <div className="mb-2 flex items-center gap-2.5">
              <span className="font-sans text-[11px] font-medium uppercase tracking-wide text-sts-subtle">
                {label}
              </span>
...
export function SettingsFormPageSkeleton() {
  return (
    <div className="flex flex-col gap-6 px-6 py-8 sm:px-10">
      ...
      <div className="max-w-2xl space-y-4 rounded-xl border border-sts-card-border bg-sts-card p-5">
        {Array.from({ length: 5 }).map((_, i) => (
    ...
    <div className="sts-page-pad h-full overflow-y-auto">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {Array.from({ length: 6 }).map((_, i) => (
          <div
            key={i}
            className="flex flex-col gap-3 rounded-xl border border-sts-card-border bg-sts-card p-4"
            style={fade(i, 0.08)}
          >
